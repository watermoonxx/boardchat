...
<body>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav" style="padding-top: 10px;">
			...
			<li><a class="nav-ele" class="nav-ele" href="find.jsp">친구찾기</a></li>
			<li><a class="nav-ele" class="nav-ele" href="boardList.jsp">자유게시판</a></li>
			<li><a class="nav-ele" class="nav-ele" href="chat.jsp">채팅</a></li>
		</ul>
			<%
			...
			<ul class="nav navbar-nav navbar-right" style="padding-top: 10px;">
				...
				<li class="active"><a class="nav-ele" href="join.jsp">회원가입</a></li>
			</ul>
			<% } %>
		</div>
	</nav>
